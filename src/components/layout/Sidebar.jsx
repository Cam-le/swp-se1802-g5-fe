    ...
    switch (user?.role_id) {
      case ROLES.DEALER_STAFF.id:
        return [
          ...
          {
            name: "Appointments",
            path: "/dealer/staff/appointments",
            icon: (
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      case ROLES.DEALER_MANAGER.id:
        return [
          ...
          {
            name: "Appointments",
            path: "/dealer/manager/appointments",
            icon: (
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
